...
cap0.set(3, 960)  # WIDTH : MAX 1920, 3 ... CV_CAP_PROF_WIDTH
cap0.set(4, 540)  # HEIGHT: MAX 1080, 4 ... CV_CAP_PROF_HEIGHT
cap0.set(5, 60)   # FPS   : MAX 60,   5 ... CV_CAP_PROF_FPS
cap1.set(3, 960)  # WIDTH : MAX 1920, 3 ... CV_CAP_PROF_WIDTH
cap1.set(4, 540)  # HEIGHT: MAX 1080, 4 ... CV_CAP_PROF_HEIGHT
